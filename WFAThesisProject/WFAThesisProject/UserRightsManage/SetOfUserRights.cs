...
namespace WFAThesisProject.UserRightsManage
{
    public class SetOfUserRights
    {
        ...
        private RightLevels uR1_ReqLocal { get; set; }
        private RightLevels uR2_AccidLocal { get; set; }
        private RightLevels uR3_UserLocal { get; set; }
        private RightLevels uR4_UserGlobal { get; set; }
        private RightLevels uR5_RightMan { get; set; }
        private RightLevels uR6_AccidGlobal { get; set; }
        private RightLevels uR7_StoreMan { get; set; }
        private RightLevels uR8_ReqMan { get; set; }
        private RightLevels uR9_Order { get; set; }
        private RightLevels uR10_Subcontr { get; set; }
        ...
        public RightLevels getuR1_Req(){ return uR1_ReqLocal; }
