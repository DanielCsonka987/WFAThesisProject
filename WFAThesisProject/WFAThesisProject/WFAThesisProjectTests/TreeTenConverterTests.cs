...
namespace WFAThesisProject.Tests
{
    ...
    public class TreeTenConverter
    {
        ...
        {
            int exp = 15;
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("0000000120",false);
        ...
        {
            int exp = 198;
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("0000021100",false);
            int act = conv.rightsNumberInTen;
            Assert.AreEqual(exp, act, "Not correct converting");
        }
        [TestMethod()]
        ...
        {
            int exp = 48249;
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("2110012000",false);
            int act = conv.rightsNumberInTen;
            Assert.AreEqual(exp, act, "Not correct converting");
        }
        [TestMethod()]
        ...
        {
            int exp = 48268;
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("2110012201",false);
            int act = conv.rightsNumberInTen;
            Assert.AreEqual(exp, act, "Not correct converting");
        }
        [TestMethod()]
        ...
        public void Test9_3To10_10digit_all2_wrongDigits()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("0111098704",false);
                Assert.Fail("Not correct converting - not recognizes formatErr");
            }
            catch (ErrorUserRightFormat err)
            {
        ...
        public void Test10_3To10_5digit_wrongSize()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("01110",false);
        ...
        public void Test11_3To10_14digit_wrongSize()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("01110110022000",false);
                Assert.Fail("Not correct converting - not recognizes lengthErr");
            }
            catch (ErrorUserRightLength err)
            {
        ...
        public void Test13_10To3_3digit()
        {
            ...
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("15",true);
        ...
        public void Test14_10To3_5digit()
        {
            ...
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("1",true);
            string act = conv.rightsNumberInThree;
            Assert.AreEqual(exp, act, "Not correct converting");
        }
        [TestMethod()]
        public void Test15_10To3_10digit_all2()
        {
            ...
            UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("59048",true);
            string act = conv.rightsNumberInThree;
            Assert.AreEqual(exp, act, "Not correct converting");
        }
        [TestMethod()]
        ...
        public void Test17_10To3_10digit_tooBig1()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("59049",true);
                string act = conv.rightsNumberInThree;
        ...
        public void Test18_10To3_10digit_tooBig1()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("100000",true);
                string act = conv.rightsNumberInThree;
                Assert.Fail("Not sends error for too great decimal number");
            }
            catch (ErrorUserRightFormat urfe)
        ...
        public void Test19_10To3_10digit_tooSmall()
        {
            try
            {
                UserRightsManage.TreeTenConverter conv = new UserRightsManage.TreeTenConverter("-10",true);
                string act = conv.rightsNumberInThree;
                Assert.Fail("Not sends error for too great decimal number");
            }
            catch (ErrorUserRightFormat urfe)
