    ...
    public class UserSetOfRightsTests
    {
        ...
        public void Test30_UR_dataIn10()
        {
            try
            {
                ...
                RightLevels exp1 = RightLevels.READ;
                RightLevels exp2 = RightLevels.MODiFY;
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("233",true);
        ...
        public void Test31_UR_dataIn10()
        {
            try
            {
                ...
                RightLevels exp1 = RightLevels.READ;
                RightLevels exp2 = RightLevels.MODiFY;
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("12001", true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
                RightLevels act1 = usor.getuR1_Req();
                RightLevels act2 = usor.getuR2_AccidLocal();
                RightLevels act3 = usor.getuR3_UserLocal();
        ...
        public void Test32_UR_dataIn10()
        {
            try
            {
                ...
                RightLevels exp1 = RightLevels.READ;
                RightLevels exp2 = RightLevels.MODiFY;
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("32011", true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
                RightLevels act1 = usor.getuR1_Req();
                RightLevels act2 = usor.getuR2_AccidLocal();
                RightLevels act3 = usor.getuR3_UserLocal();
        ...
        public void Test33_UR_dataIn10()
        {
            try
            {
                ...
                RightLevels exp1 = RightLevels.READ;
                RightLevels exp2 = RightLevels.MODiFY;
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("0", true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
                RightLevels act1 = usor.getuR1_Req();
                RightLevels act2 = usor.getuR2_AccidLocal();
                RightLevels act3 = usor.getuR3_UserLocal();
        ...
        public void Test34_UR_dataIn10()
        {
            try
            {
                ...
                RightLevels exp1 = RightLevels.READ;
                RightLevels exp2 = RightLevels.MODiFY;
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("59048",true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
                RightLevels act1 = usor.getuR1_Req();
                RightLevels act2 = usor.getuR2_AccidLocal();
                RightLevels act3 = usor.getuR3_UserLocal();
        ...
        public void Test35_UR_dataIn10_wrongRange()
        {
            try
            {
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("59049", true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
        ...
        public void Test36_UR_dataIn10_wrongRange()
        {
            try
            {
                UserRightsManage.TreeTenConverter ttc = new UserRightsManage.TreeTenConverter("-1", true);
                SetOfUserRights usor = new SetOfUserRights(ttc.rightsNumberInThree);
