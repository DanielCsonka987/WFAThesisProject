...
namespace WFAThesisProject
{
    public partial class MainController
    {
        ...
        private FormMainController05Ordering ordering;
        private FormMainController02Accidents accidents;
        private FormMainController04Requests requests;
        private FormMainController06Subcontr subcontructors;
        private FormMainController01UsersManage globalUsers;
        ...
        private void loadInGridToShowProperContent()
        {
            if (mainWindow.Visible == true)
            {
                ...
                else if (actServiceForSubEvents == FormMainServiceMode.REQUESTSMAN)
                {
