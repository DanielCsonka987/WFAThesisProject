...
namespace WFAThesisProject.UserNamePasswordManage
{
    public class SetOfUserDetails
    {
        ...
        public string userName { get; set; }         //the username - with user logs in
        ...
        {
            if (userAccountGroup == null || userName == null || userId == null || userLastName == null ||
                userFirstName == null || userTaj == null || userPosition == null || userArea == null)
                throw new ErrorUserDetailsCompletlyness("Felhasználói adatok nem teljes");
        }
    }
}
