...
namespace WFAThesisProject
{
    public partial class FormMainWindow : MetroFramework.Forms.MetroForm
    {
        ...
        private FormServiceProfileWindow userOwnDetailsManage;
        ...
        private void mTileUserOwnDetail_Click(object sender, EventArgs e)
        {
            ...
            userOwnDetailsManage = new FormServiceProfileWindow(setOfUserDetails, dbci, this);
    ...
    /// </summary>
    public enum FormMainServiceMode { OPENING,
        USERSMAN,
        ACCIDENTSMAN,
